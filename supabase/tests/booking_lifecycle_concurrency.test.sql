...
select extensions.dblink_connect('lifecycle_one', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
select extensions.dblink_connect('lifecycle_two', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
